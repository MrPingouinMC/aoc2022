...
execute if score STEP REG matches 0 if score CHAR REG matches -1 run scoreboard players set CONTINUE REG 0

execute if score STEP REG matches 0 if score CHAR REG matches -1 run scoreboard players operation SIGN REG *= -1 CONST
